...
class Language(db.Model):
    ...
    part_list = db.relationship('Part', backref='languages', passive_deletes=True, lazy='dynamic')
...
class Part(db.Model):
    ...
    chapter_list = db.relationship('Chapter', backref='parts', passive_deletes=True, lazy='dynamic')
